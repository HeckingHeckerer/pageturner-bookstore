...
<div class="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <!-- Header -->
            <div class="px-6 py-6 border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-indigo-700">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="border-t border-gray-200 pt-8">
                        <h3 class="text-lg font-medium text-gray-900 mb-6">Default Shipping Information (Optional)</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-input-label for="default_shipping_address" :value="'Address'" />
                                <x-text-input id="default_shipping_address" class="block mt-1 w-full" type="text" name="default_shipping_address" :value="old('default_shipping_address')" autocomplete="address-line1" />
                                <x-input-error :messages="$errors->get('default_shipping_address')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="default_shipping_city" :value="'City'" />
                                <x-text-input id="default_shipping_city" class="block mt-1 w-full" type="text" name="default_shipping_city" :value="old('default_shipping_city')" autocomplete="address-level2" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                            <div>
                                ...
                                <x-text-input id="default_shipping_state" class="block mt-1 w-full" type="text" name="default_shipping_state" :value="old('default_shipping_state')" />
                                <x-input-error :messages="$errors->get('default_shipping_state')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="default_shipping_zip" :value="'ZIP Code'" />
                                <x-text-input id="default_shipping_zip" class="block mt-1 w-full" type="text" name="default_shipping_zip" :value="old('default_shipping_zip')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="default_shipping_country" class="block mt-1 w-full" type="text" name="default_shipping_country" :value="old('default_shipping_country')" />
