    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="category_id" id="category_id" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('category_id') border-red-500 @enderror" required>
            ...
            @if($book->cover_image)
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2">Current Cover Image</label>
                    <div class="flex items-center space-x-4">
                        <img src="{{ asset('storage/' . $book->cover_image) }}" alt="Current cover" class="w-20 h-28 object-cover rounded border">
            ...
            {{-- Cover Image --}}
            <div class="mb-6">
                <label for="cover_image" class="block text-gray-700 font-medium mb-2">Change Cover Image</label>
